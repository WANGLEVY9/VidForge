...
- [x] Reuse the production JWT secret policy across authentication and notification modules.
...
- [x] Add opt-in human-review checkpoints for policy-sensitive outputs.
